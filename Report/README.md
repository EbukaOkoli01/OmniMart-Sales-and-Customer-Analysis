## 🧾 OmniMart Project Report

This folder contains the full business analysis report for the **OmniMart Sales and Customer Analysis** project.
...
📘 **File:**  
- `OmniMart_Full_Project_Report.pdf` — Complete project write-up and executive summary.
